 ...
 * <BR>
 *
 * This class supports the processing of images.<BR>
 * <BR>
 * 
 ...
 * converts it to grayscale, and draws it:<BR>
 * <BR>
 * 
 * <pre>
 ...
 *
 * <pre>
 * java -Xmx<I>new Size</I>m <I>programFileName</I>
 * </pre>
 *
...
public class APImage extends JFrame implements Iterable<Pixel> {
    ...
    /**
     * Creates an image from a file dialog selection or creates a blank image if the
     * user cancels.
     */
    public APImage() {
    ...
    /**
     * Saves the image under its current file name or runs <code>saveAs</code> if no
     * file name yet.
     */
    public boolean save() {
        if (fileName.equals(""))
